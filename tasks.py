    ...
    def writer_task(self, agent):
        return Task(
            description=dedent(f"""\
                ...
                - Given the writing piece from the output of the extraction_task, conduct an in-depth analysis to identify patters of language and stylistic quality of the text. 
                ...
                - Use the context given from analyze_prompt_task as the topic of your writing. Understand this topic fully and be ready to write on it.
                - Using the context given from research_task, analyze this report to identify all the context from this report that can be used to write a new writing piece on the topic you are to write on.
